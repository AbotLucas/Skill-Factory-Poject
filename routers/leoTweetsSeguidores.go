...
func LeoTweetsSeguidores(w http.ResponseWriter, r *http.Request) {
	...
	//Chequeo que haya venido la pagina
	if len(r.URL.Query().Get("pagina")) < 1 {
		http.Error(w, "Debe enviar el parametro pagina", http.StatusBadRequest)
		return
	}
	//Vamos a trabajar con la paginacion
	...
	en respuesta nos va a venir todo el documento de json que vamos a tener
	que enviar al HTTP y ademas de un booleano, correcto */
	...
	//le devolvemos la respuesta en formato json que esta en respuesta
