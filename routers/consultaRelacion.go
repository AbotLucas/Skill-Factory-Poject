...
/* ConsutaRelacion chequea si hay una relacion entre los dos usuarios */
func ConsultaRelacion(w http.ResponseWriter, r *http.Request) {
	...
	/* Defino una variable resp en donde voy a tener la respues de si hay relacion o no entre los usuarios */
